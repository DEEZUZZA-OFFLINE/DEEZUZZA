...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('Gʀᴏᴜᴘ', url=f"https://t.me/cinema_city_group")
            ]
            ]
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('💠 Gʀᴏᴜᴘ 💠', url='https://t.me/cinema_city_group') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
